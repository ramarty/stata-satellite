{smcl}
{* *! version 0.0 20250314}{...}
{hline}
{pstd}help file for {hi:query_satellite_data}{p_end}
{hline}

{title:Title}

{phang}{bf:query_satellite_data} - This command is used for short description.
{p_end}

{title:Syntax}

{phang}{bf:query_satellite_data} , {bf:{ul:opt}ion1}({it:string})
{p_end}
