...
{hline}
{pstd}help file for {hi:query_geojson}{p_end}
{hline}

{title:Title}

{phang}{bf:query_geojson} - This command is used for short description.
{p_end}

{title:Syntax}

{phang}{bf:query_geojson} , {bf:{ul:opt}ion1}({it:string})
{p_end}
